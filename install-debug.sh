...
################################################################################
    ...
    if [[ ("$DISTRO" == "16") ]]; then
    sudo apt -y install php7.3-fpm php7.3-opcache php7.3 php7.3-common php7.3-gd php7.3-mysql php7.3-imap php7.3-cli php7.3-memcache php7.3-memcached memcached\
    ...
    # Compil Blocknotify
    cd ~
    git clone https://github.com/0x000000000019b6/yiimp
